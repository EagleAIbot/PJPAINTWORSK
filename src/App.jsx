...
import {
  ...
  Palette, Sparkles, ImageIcon, Zap, Paperclip,
  Shield, Truck, Award, Pencil,
} from 'lucide-react'
...
function App() {
  ...
  const handleCommSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('https://formsubmit.co/ajax/hello@pjpaintworks.co.uk', { method: 'POST', body: fd })
      if (res.ok) setCommSubmitted(true)
      else setCommError(true)
    } catch { setCommError(true) }
  ...
  const trustItems = [
    { icon: Shield, heading: 'All originals',       sub: 'No prints. No reproductions. Ever.' },
    { icon: Truck,  heading: 'Ships UK-wide',        sub: 'Insured, tracked delivery on all pieces.' },
    { icon: Award,  heading: '25+ years of craft',  sub: 'Tattooist, muralist, fine artist.' },
    { icon: Pencil, heading: 'Commission from £150', sub: 'Bespoke artwork built around your brief.' },
  ]
  ...
  // Only actual artwork pieces — commissions are a separate CTA
  const shopItems = [
    {
      title: "Batman STOP Bring Coffee Sign",
      desc: "Aerosol on metal road sign. Bold, funny, one of a kind.",
    ...
    },
    {
      ...
      price: "£250", tag: "FOR SALE", tagColor: "#C9A96E", sold: false,
    ...
    },
    {
      ...
      price: "£10", tag: "FOR SALE", tagColor: "#C9A96E", sold: false,
    ...
    {
      title: "Betty Boop Mirror",
      desc: "Coca-Cola x Betty Boop custom painted mirror. Pop art, wall-ready.",
      price: "£POA", tag: "FOR SALE", tagColor: "#C9A96E", sold: false,
      img: img('coke-bettyboop-mirror.png'), href: "#commission",
    },
    {
      title: "Anarchy Portrait",
      desc: "Airbrushed b&w portrait with anarchy symbol. Framed and ready to hang.",
      price: "£50", tag: "FOR SALE", tagColor: "#C9A96E", sold: false,
      img: img('portrait-anarchy.png'), href: "#commission",
    },
  ]
  ...
  const process = [
    ...
    { n: "03", title: "The Build",    desc: "Work begins. Progress shots shared throughout so you're always in the loop." },
        ...
        <div className="trust-strip-inner">
          {trustItems.map((t, i) => (
            <motion.div key={i} className="trust-item"
              ...
              <div className="trust-icon"><t.icon size={20} strokeWidth={1.5} /></div>
              <div>
                <p className="trust-heading">{t.heading}</p>
        ...
        <div className="about-container">
          <motion.div className="about-content" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            <div className="about-text">
              <p className="section-label">About PJ</p>
              <h2 className="about-title">25 years of turning ideas into art.</h2>
              <div className="about-body">
                <p>PJ has always had an eye for art. What started as a passion for drawing found its place in tattooing, and for more than 25 years he's been turning ideas into permanent works of art on skin. He built a large and loyal client base at his own studio, Rising Phoenix, with people returning time and again for his distinctive style.</p>
                <p>That passion has grown into PJ Paintworks — an online art shop where creativity runs free. From custom street signs to canvas originals, murals to one-off commissions, every piece carries the same obsessive attention to detail. No prints. No reproductions. The real thing, every time.</p>
              </div>
              <div className="about-links">
                <a href="#commission" className="about-cta">Commission a piece <ArrowRight size={16} /></a>
                <a href="https://www.risingphoenixtattoo.co.uk" target="_blank" rel="noopener noreferrer" className="about-studio">Rising Phoenix Tattoo →</a>
              </div>
            </div>
      ...
      <section id="shop" className="shop">
        <div className="shop-container">
          <motion.div className="section-header" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="section-subtitle">Every item is an original. No prints, no reproductions. Once it's gone, it's gone.</p>
          </motion.div>
          <div className="shop-grid">
            {shopItems.map((item, i) => (
              <motion.a key={i} href={item.sold ? undefined : item.href}
                ...
                <div className="shop-card-img">
                  {item.img
                    ...
                    : <div className="shop-card-img-placeholder"><ShoppingBag size={32} strokeWidth={1} /></div>
                  }
                ...
                <div className="shop-card-info">
                  <div className="shop-card-row">
                    ...
                    <span className="shop-card-price" style={item.sold ? { opacity: 0.45, textDecoration: 'line-through' } : {}}>{item.price}</span>
                  </div>
                  {!item.sold && <span className="shop-card-cta">Enquire <ArrowRight size={13} /></span>}
                </div>
              </motion.a>
            ))}
          </div>
          ...
          {/* Commission banner */}
          <motion.div className="commission-banner"
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}>
            <div className="commission-banner-text">
              <p className="section-label" style={{ marginBottom: '0.5rem' }}>Can't see what you want?</p>
              <h3 className="commission-banner-title">Commission something unique.</h3>
              <p className="commission-banner-sub">Street signs, murals, canvas, helmets — if you can imagine it, PJ can build it. Enquiries from £150.</p>
            </div>
            <a href="#commission" className="commission-banner-btn">Start a Commission <ArrowRight size={16} /></a>
          </motion.div>
        </div>
      </section>
      ...
      <section id="commission" className="contact">
        <div className="contact-container">
          <motion.div className="contact-header" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="contact-subtitle">Tell PJ what you're after. Every enquiry gets a personal reply. Got reference images? Attach them below.</p>
          </motion.div>
          <div className="contact-content">
            <motion.div className="contact-info" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <div className="contact-item"><Phone size={20} /><a href="tel:+44000000000">Call directly</a></div>
              <div className="contact-item"><Mail size={20} /><a href="mailto:hello@pjpaintworks.co.uk">hello@pjpaintworks.co.uk</a></div>
              <div className="contact-turnaround"><Clock size={16} />Replies within 24 hours</div>
              ...
              {!commSubmitted ? (
                <form className="contact-form" onSubmit={handleCommSubmit}>
                  <div className="form-row">
                    <div className="form-group"><input type="text"  name="name"  value={commData.name}  onChange={handleCommChange} required placeholder="Your name" /></div>
                    <div className="form-group"><input type="tel"   name="phone" value={commData.phone} onChange={handleCommChange} required placeholder="Phone number" /></div>
                  </div>
                  <div className="form-group"><input type="email" name="email" value={commData.email} onChange={handleCommChange} required placeholder="Email address" /></div>
                  <div className="form-group">
                    <textarea name="message" value={commData.message} onChange={handleCommChange} rows="6" required
                      placeholder="Describe your idea. What, what size, what style, any references, timescale, budget. The more detail the better." />
                  </div>
                  <div className="form-group">
                    ...
                    {commFile && (
                      <button type="button" className="file-remove" onClick={() => { setCommFile(null); fileRef.current.value = '' }}>Remove ×</button>
                    )}
                  </div>
                  ...
                  {commError && <p className="form-error">Something went wrong. Email <a href="mailto:hello@pjpaintworks.co.uk">hello@pjpaintworks.co.uk</a> directly.</p>}
                </form>
              ) : (
                <motion.div className="form-success" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4 }}>
                  <CheckCircle2 size={48} />
                  <h3>Enquiry received</h3>
                  <p>PJ will get back to you personally within 24 hours.</p>
                  <button onClick={() => { setCommSubmitted(false); setCommData({ name: '', email: '', phone: '', message: '' }); setCommFile(null) }} className="form-reset">Send another message</button>
                </motion.div>
              )}
            </motion.div>
          </div>
        ...
        <div className="support-container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="support-links">
              <a href="mailto:hello@pjpaintworks.co.uk" className="support-email"><Mail size={18} /> hello@pjpaintworks.co.uk</a>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="footer-container">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <p className="footer-tagline">Every piece an original.</p>
            </div>
            <div className="footer-newsletter">
              <p className="footer-newsletter-label">New pieces. Commission slots. Drops.</p>
              {!emailDone ? (
                <form className="footer-email-form" onSubmit={(e) => { e.preventDefault(); setEmailDone(true) }}>
                  <input type="email" value={emailVal} onChange={e => setEmailVal(e.target.value)} required placeholder="Your email address" className="footer-email-input" />
                  <button type="submit" className="footer-email-btn">Notify me <ArrowRight size={14} /></button>
                </form>
              ) : (
                <p className="footer-email-done">You're in. We'll let you know when new pieces drop.</p>
              )}
            </div>
          </div>
          <div className="footer-bottom">
            <p className="footer-text">© {new Date().getFullYear()} PJ Paintworks. All rights reserved.</p>
            <div className="footer-links">
              ...
              <a href="https://www.risingphoenixtattoo.co.uk" target="_blank" rel="noopener noreferrer">Rising Phoenix</a>
            </div>
          </div>
        </div>
      </footer>
